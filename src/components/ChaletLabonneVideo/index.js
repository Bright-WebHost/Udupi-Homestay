...
import videoFile from '../../images/video/Chalet La.mp4'; // Ensure the video file is in the correct path.

const ChaletLabonneVideo = (props) => {
    const ClickHandler = () => {
...
export default ChaletLabonneVideo;
